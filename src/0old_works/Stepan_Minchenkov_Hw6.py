...
def coloring(color_number: int, digit_to_display: str, output_lines: list):
    ...
    digits = {
        '0': [color + color + color + color,
              color + blank + blank + color,
              color + blank + blank + color,
              color + blank + blank + color,
              color + color + color + color],
        '1': [blank + color + color + blank,
              blank + blank + color + blank,
              blank + blank + color + blank,
              blank + blank + color + blank,
              color + color + color + color],
        '2': [color + color + color + color,
              blank + blank + blank + color,
              color + color + color + color,
              color + blank + blank + blank,
              color + color + color + color],
        '3': [color + color + color + color,
              blank + blank + blank + color,
              color + color + color + color,
              blank + blank + blank + color,
              color + color + color + color],
        '4': [color + blank + blank + color,
              color + blank + blank + color,
              color + color + color + color,
              blank + blank + blank + color,
              blank + blank + blank + color],
        ...
        '7': [color + color + color + color,
              ...
              blank + blank + blank + color,
              blank + blank + blank + color],
        '8': [color + color + color + color,
              color + blank + blank + color,
              color + color + color + color,
              color + blank + blank + color,
              color + color + color + color],
        '9': [color + color + color + color,
              color + blank + blank + color,
              color + color + color + color,
              blank + blank + blank + color,
              color + color + color + color],
